 ...
 <div class="container">
    ...
    <form action="" class="contact_form">
        <ul>
                ...
                <center><h2>Reiniciar encuesta</h2>
                <a href="javascript:confirmacion_borrar('restartAll.php');"><input type="button" class="btn-danger submit" value="REINICIAR"/></a></center>
...
<script>
      function confirmacion_borrar(link) {
        if ( confirm("Está seguro de reiniciar los resultados del clima") )
