...
if(isset($_POST['create_pdf'])){
        ...
        <table border="1" cellpadding="10">
          <thead>
            <tr>
              ...
              <th align="center" bgcolor="#000000" style="color:white"><b>Area</b></th>
              <th align="center" bgcolor="#000000" style="color:white"><b>Campo</b></th>
              <th align="center" bgcolor="#000000" style="color:white"><b>Jefe / Coordinador</b></th> 
            </tr>
          </thead>';
	...
	$content .= '
      ...
      <td align="center">'.$NameArea.'</td>
      <td align="center">'.$NameCampo.'</td>
      <td align="center">'.$row['id_jefe'].'</td>
    </tr>';
	}
                ...
                <tbody> 
                  <?php 
                    foreach ($respuesta as $key) {
                      $NameCampo = $BD->GetCampo($key['campo']);
                      $NameArea = $BD->GetArea2($key['area']);
                  ?>
                  <tr>
                    ...
                    <td ><?php echo $NameCampo; ?></td>
                    <td ><?php echo $key['id_jefe']; ?></td>
                  </tr>
                  <?php 
                    } 
                  ?>
