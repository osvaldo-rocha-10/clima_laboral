...
<head>
  <meta charset="UTF-8">
  <title>Grafica Telaraña | CLIMA LABORAL ADMINISTRADORL</title>
 ...
 while ($i <= $cantidad) {
    ...
    if ($existencia != 0) {
      ...
      if ($tipo == 1) {
                        ...
                        $res = $BD->ContarRespuestasSatisfecho($id2);
                        $respuestas = $BD->ContarRespuestasGENERAL($id2);
                        if ($respuestas != 0) {
 ...
 while ($i <= $cantidad) {
    ...
    if ($existencia != 0) {
      ...
      if ($tipo == 1) {
                        ...
                        $res = $BD->ContarRespuestasNeutroNueva($id2);
                        $respuestas = $BD->ContarRespuestasGENERAL($id2);
                        if ($respuestas != 0) {
                            $porcentaje = round((($res / $respuestas) * 100), 2);
                              $suma = $suma+$porcentaje;
 ...
 while ($i <= $cantidad) {
    ...
    if ($existencia != 0) {
      ...
      if ($tipo == 1) {
                        ...
                        $res = $BD->ContarRespuestasInsatisfechoNueva($id2);
                        $respuestas = $BD->ContarRespuestasGENERAL($id2);
                        if ($respuestas != 0) {
                            $porcentaje = round((($res / $respuestas) * 100), 2);
                              $suma = $suma+$porcentaje;
