    ...
    <div class="row content">
      ...
      <div class="col-sm-2 sidenav">
        <!--<form method="post">-->
          ...
          <input type="submit" href="export_excel.php" name="create_pdf" class="btn btn-danger pull-right" style="width:150px;height:50px" value="Generar PDF">
          <br><br><br><br>
          <a href="export_excel.php"><input type="button" name="create_pdf" class="btn btn-success pull-right" style="width:150px;height:50px" value="Generar Excel"></a>
        <!--</form>-->
      </div>
    </div> 
  </div>
