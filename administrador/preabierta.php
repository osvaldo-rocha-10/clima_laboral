...
<!DOCTYPE html>
 <html class="no-js"> 
    <head>
	<title>Preguntas Abiertas | CLIMA LABORAL ADMINISTRADOR</title>
    <meta charset="utf-8"> 
        ...
        <aside id="fh5co-aside" role="complementary" class="border js-fullheight">
            ...
            <nav id="fh5co-main-menu" role="navigation">
                <ul>
                    ...
                    <li><a href="verCampos.php">Ver campos</a></li>
                     <li><a href="faltantes.php">Faltantes</a></li>
                     <li class="fh5co-active"><a href="preabierta.php">preguntas abiertas</a></li>
                   <li><a href="reiniciar.php">Reiniciar  encuesta</a></li>
                     <li><a href="Bloques/index2.php">Ver Graficas</a></li>
                     <li><a href="pdfAll.php">Respuestas todas</a></li>
          ...
          $area = $BD->mostrarareas();
            ...
            foreach ($area as $row) {
                ...
                echo '<td width="5%" ALIGN="center"><h4>'.$row['id_depto'].'</h4></td>';
                            ...
                            echo '<td width = "10%" >
                            <h4>
                            <a href="pdf.php?claves='. $row['id_depto'] .'">'.
                            $row['nombre']
                            .'
